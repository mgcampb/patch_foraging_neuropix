...
[xxx,resnorm,residual,exitflag,output,lambda,jacobian] = lsqnonlin(@point2line,[estimate(1) estimate(2)],[],[],optimset('Display','off','MaxFunEvals',500),x,y);            %Least square fitting
