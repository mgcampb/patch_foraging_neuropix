...
% modified 7 Aug 2020 to predict time to leave, not PRT
...
session = {'78_20200310','78_20200311','80_20200315','80_20200316','80_20200317'};
rew_size = [1 2 4];
...
opt.rew_size = rew_size(i2); % reward size to analyze
...
for i = 1:size(pca_selected_patches,3)
    ...
    for shuf_idx = 1:opt.num_shuf
        % y = prt(randsample(numel(prt),numel(prt)))-t_on_patch;
