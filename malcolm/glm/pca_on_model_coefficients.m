...
paths.figs = 'C:\figs\patch_foraging_neuropix\glm_pca_on_model_coefficients\20210514_accel';
...
sig_cells = sig_cells_table.sig_cells;
ctab = crosstab(sig_cells.GMM_cluster,sig_cells.WaveformType);
ctab = ctab(:,[2 3 1]);
