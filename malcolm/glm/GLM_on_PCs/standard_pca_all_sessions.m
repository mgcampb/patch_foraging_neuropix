...
% MGC 6/26/2021 Computes for all sessions and saves

% paths
paths = struct;
paths.data = 'G:\My Drive\UchidaLab\PatchForaging\processed_neuropix_data';
paths.save = 'G:\My Drive\UchidaLab\PatchForaging\pca';
paths.sessions_to_analyze = 'C:\data\patch_foraging_neuropix\GLM_output\20210526_full'; 
...
session_all = dir(fullfile(paths.sessions_to_analyze,'*.mat'));
...
for i = 1:numel(session_all)
    ...
    %% save PCs to file
    save(fullfile(paths.save,opt.session),'score','coeffs','opt','good_cells','in_patch','in_patch_buff');
end