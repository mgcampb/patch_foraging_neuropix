...
% save(fullfile(paths.sig_cells,sprintf('sig_cells_%s_cohort_%s',opt.data_set,opt.brain_region)),'psth_all','-append');
...
hfig.Name = sprintf('PSTH patch stop GMM cluster RR vs R0 %s cohort %s',opt.data_set,opt.brain_region);
