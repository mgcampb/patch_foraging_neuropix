...
for shuffle = 1:3
    dataset_opt.features{shuffle} = struct;
    dataset_opt.features{shuffle}.type = "KMeans Clusters";
    dataset_opt.features{shuffle}.ix = [1 2 3]; % indices within the feature type we selected
    dataset_opt.features{shuffle}.shuffle = true; % shuffle?
    dataset_opt.features{shuffle}.name = sprintf("Shuffled Neural Data %i",shuffle); % name for visualizations
end
