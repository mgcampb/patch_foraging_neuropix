...
%       .colors       Adds coloring scheme by condition, in form of cell array (added by JS 6/19/2020)
%       .fname        If given, save an mp3 to the given filename (added by JS 6/19/2020)
...
if exist('movieParams', 'var') && isfield(movieParams,'colors')
    frameParams.colors = movieParams.colors;
end

if exist('movieParams', 'var') && isfield(movieParams,'fname')
    v = VideoWriter (movieParams.fname);
    open (v);
end
