function [sorted_peth,neuron_order,unsorted_peth_norm,peak_ix] = peakSortPETH(FR_decVar,dvar,decVar_bins,opt)
...
%         disp(size(postStop_bool))
    ...
    [~,peak_ix] = max(unsorted_peth'); % max(unsorted_peth'); 
    
    [~,neuron_order] = sort(peak_ix); 
